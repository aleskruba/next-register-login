...
import { deleteStudent, fetchClasses, fetchStudent, updatePassword, updateProfileImage, updateStudent } from "@/utils";
...
const Post: FC<Props> = ({params}) => {
  ...
  const uploadImage = async () => {
    try {
      ...
      const data =  {imageUrl:imageUrl, userID:student?.id , role:student?.role}
